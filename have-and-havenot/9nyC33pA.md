...
That said, there's definitely some kind of unwillingness to, well, do anything behind 4's words and tone thus far. However, there shouldn't be any reason for the summoned to be like this.
...
"Uh… sure…? Anyways, for a second imagine that 10 was a single digit number, let say using the letter A. If we do that 1A would functionally be 21 right?"
...
"I don't understand what you mean when you say you need to save your daughter since I still don't quite understand what kind of danger this daughter of yours is in."
