...
"user cache is_toxic as function accept item, return item's excriments includes neurotoxin"
"user cache toxic_bacteria as quarenteed_bacteria's filter using is_toxic.”
...
Right trying to explain how running a script to find all the bacteral that produces nerotoxins i currently have within quarentee within me isn't really going to answer this question and probably would lead to more questions...

"I'm uhh... casting a spell to... uhhh... prepaire for the next round?"

"Hun what are spells?"

"It's like uhh you know those crazy things that all of you seem to do in order to 'bend the world to your will' or something like that"

"You mean using an ability? dont you normally just activate them like they're just another limb or something? why would you need to chant for something like that? it's not like you use a change to move your arms right?"

Now that I think about it, no one really screams their attacks or abilities out loud...

"Well uhh... that's not important right now... can you all give me some space to so I can focus a bit?"

The crowd of people sitting around me quieted down as I continued executing my scripts.

"user cache toxic_culture as culture_bacteria using toxic_bacteria"
"user move toxic_culture into mouth"
"user echo toxic_culture's unique_count"

_$ 37_

Hmm that's more than I thought... when did I acquire so many bugs that produces neurotoxins...

"user list toxic_culture"

A flood of information about all the various bacteria that i'm currently culturing appeared in my mind.

Majority of them dont exactly line up with pre-existing data about bacteria but most of them seem to be related to bacteria that does exist in the bacterial database. 
