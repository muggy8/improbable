...
Maybe just treating this whole world like some sort of fictional fantacy world isn't really the right move.
...
"user cache culture_set as empty list"
"user culture_set's add using toxic_bacteria's 8th"
"user culture_set's add using toxic_bacteria's 19th"
"user culture_set's add using toxic_bacteria's 20th"
"user culture_set's add using toxic_bacteria's 27th"
"user culture_set's add using toxic_bacteria's 31st"
